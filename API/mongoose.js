...
const guildConfigSchema = mongoose.Schema({
  ...
  bienvenue: {
    message: {
      ...
      description: {
        type: String,
        default: "{member} a rejoint le serveur, invité par {inviter} !",
      },
    },
...
const privateVoice = mongoose.Schema({
  guild: String,
  voiceChanel: String, 
  code: String,
}) 

const connectionToken = mongoose.Schema({
  user: String,
  token: String,
})

module.exports.privateVoice = mongoose.model("privateVoice", privateVoice, "privateVoice")
...
module.exports.connectionTokens = mongoose.model("connectionTokens", connectionToken, "connectionTokens");